...
import { fetchHomepageData } from "../../redux/newsSlice";
...
export default function Homepage() {
  ...
  const bottomSliderData = [
    {
      ...
      description:
        "Jelajahi keindahan budaya dan sejarah kota Malang dengan panduan seru dan edukatif.",
      backgroundColor: "rgba(0, 202, 163, 1)",
    },
    {
      title: "Yuk Tulis Beritamu Sendiri di Portal Komunitas Mbois!",
      description:
        "Punya info menarik di sekitarmu? Suarakan opinimu dan bagikan cerita inspiratifmu sekarang.",
      backgroundColor: "rgba(76, 175, 80, 1)",
    },
    {
      title: "Grup Diskusi Kreatif Pemuda Malang Raya Resmi Dibuka",
      description:
        "Gabung bersama ribuan kreator lokal untuk membangun ekosistem digital Malang yang lebih maju.",
  ...
  }, [bottomSliderData.length]);

  const sliderData = sliderNews?.slice(0, maxSlide) || [];
      ...
      <div className="popular-news-group">
        ...
        <div className="container-popular-news">
          {topNews?.slice(0, 3).map((item, index) => {
            const itemCategory = getCategoryName(item.categories, "News");
            ...
            return (
              <>
                <CardPopular
                  ...
                  title={updatedTopItem.title}
                  date={updatedTopItem.isoDate}
                  fullData={updatedTopItem}
                />
            ...
            currentTodayNews.map((item, index) => {
              ...
              return (
                <CardRecomended
                  ...
                  image={getValidImage(updatedTodayItem.image)}
